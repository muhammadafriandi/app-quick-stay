...
const RecomendedHotels = () => {
  ...
  return recomended.length > 0 && (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
      ...
      <Title title='Recomended Hotels' subTitle='Discover our handpicker selection of exceptional properties around the world, offering unparalleled luxury and unforgettable experiences.' />
